...
Begin VB.Form JournalDaybook 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Journal Daybook"
   ClientHeight    =   7020
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10755
   ...
   Begin RichTextLib.RichTextBox RichTextBox1 
      ...
      ReadOnly        =   -1  'True
      ScrollBars      =   3
      TextRTF         =   $"frmJournalDaybook.frx":0000
   ...
   End
End
Attribute VB_Name = "JournalDaybook"
...
If NumberOfRecords > 0 Then
    RichTextBox1.LoadFile "c:\vbprog\vba\rpt\jdaybook.txt", rtfText
...
Private Sub DaybookHeader()
    ...
    Print #1, PADC("JOURNAL DAY BOOK", PageWidth)
...
'    DaybookDetailRS.Close
    ...
    DaybookDetailRS.Open "select acn_date,entry_id,actitle,particular,debit," _
     ...
     & "acn_date between {" & Format(FromDate, "mm/dd/yyyy") & "} and {" & Format(ToDate, "mm/dd/yyyy") & "} and cj='" & "J" & "' order by " _
    ...
    Open "c:\vbprog\vba\rpt\jdaybook.txt" For Output As #1
