...
Begin VB.Form ViewTransaction1 
   ...
   Begin MSFlexGridLib.MSFlexGrid grdTransact 
      ...
      HighLight       =   2
      AllowUserResizing=   1
      FormatString    =   $"frmViewTrans1.frx":0000
   ...
   End
End
Attribute VB_Name = "ViewTransaction1"
...
Private Sub Form_Activate()
    ...
    Me.Caption = "Journal Transactions for " & Format(CurrentDate, "dd/mm/yyyy")
