...
Private Sub ProfitHeader()
    ...
    'Print #1, "PARTICULARS "; Tab(51); Spc(8); "AMOUNT"; Tab(65); Spc(4); "PARTICULARS OF INCOME"; Tab(119); Spc(8); "AMOUNT"
...
Print #1, Tab(67); ZeroSup(ProfitRS!head_bal2)
...
'*************
    If CashTrans > 0 Then
            ...
            If IsTrading Then
            ProfitRS!ACTITLE1 = "GROSS PROFIT"
            Else
            ProfitRS!ACTITLE1 = "CLOSING STOCK"
            End If
