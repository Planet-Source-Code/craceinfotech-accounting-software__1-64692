...
Begin VB.Form CashDaybook 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cash Daybook"
   ClientHeight    =   7020
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10755
   ...
   Begin RichTextLib.RichTextBox RichTextBox1 
      ...
      ReadOnly        =   -1  'True
      ScrollBars      =   3
      TextRTF         =   $"frmCashDaybook.frx":0000
...
If NumberOfRecords > 0 Then
    RichTextBox1.LoadFile "c:\vbprog\vba\rpt\cdaybook.txt", rtfText
...
Private Sub DaybookHeader()
    ...
    'Print #1, PADC("CASH DAY BOOK", PageWidth)
    Print #1, PADC("DAY BOOK - " + FinancialYear, PageWidth)
...
Private Sub PrepareDaybook()
    ...
    DaybookDetailRS.Open "select acn_date,entry_id,actitle,particular,debit," _
     ...
     & "acn_date between {" & Format(FromDate, "mm/dd/yyyy") & "} and {" & Format(ToDate, "mm/dd/yyyy") & "} and cj='" & "C" & "' order by " _
    ...
    Open "c:\vbprog\vba\rpt\cdaybook.txt" For Output As #1
